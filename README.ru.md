...
| `LEP-ROUTE-CLEAN` | уборка лишних вершин маршрута (близнецов рядом с опорами) |
...
[LEP-README.md](LEP-README.md). То, что программа пока делает по догадке и
что ждёт подтверждения от инженера-электрика, вынесено отдельно — в
[LEP-QUESTIONS.md](LEP-QUESTIONS.md).
